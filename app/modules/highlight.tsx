...
export function Highlight(props: {title: string, subtitle: string, content: ReactNode, colStart: number, rowStart: number, w: number, h: number, bg: CardType, href?: string}) {
    ...
    return (
        ...
        <div onClick={handleClick} style={{
            ...
            }} className="rounded-4xl flex flex-col h-full">
